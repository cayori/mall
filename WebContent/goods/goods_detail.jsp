...
<table width = "960" cellspacing="0" cellpadding = "0" border="0" align="center">
	<tr>
				...
				<table width="300" height="200" border="0">
					...
					<tr>
						...
						<td width="58" rowspan="2">
							<input name="amount" type="text" style="test-align : right" value="1" size="4" />
						</td>
						<td valign="bottom">
							<div align="center">
					...
					<tr>
						...
						남은 수량 (${itemArray.GOODS_AMOUNT })개
						</td>
					</tr>
					<tr>
						<td colspan="4"> 크기&nbsp;&nbsp;&nbsp;&nbsp; 
				...
				<table align="center">
					<tr>
						...
						if(prevpage.getGOODS_NUM() != 0){
							if(price.equals("no")){
						%>
							<a href="Goods_Detail.go?search=prev&gr_goods_num=<%=itemArray.getGOODS_NUM() %>
							&item=<%=category %>">
						<%
							} else {
						%>
						...
						<%
							if(price.equals("no")){
						%>
							<a href="Goods_Detail.go?search=next&gr_goods_num=<%=itemArray.getGOODS_NUM() %>
							&item=<%=category %>">
						<%
							} else {
						%>
		...
		<table width="200" border="0" align="center">
			<tr align="left">
				<td colspan="3"> <c:forEach var ="itemimg" items="${requestScope.contentImage }">
