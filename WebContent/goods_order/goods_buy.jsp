	...
	<tr>
			...
			<%
				if(ordertype.equals("goods"))
				{
					...
					<tr align=center height=20>
						<td style="font-family: Tahoma; font-size: 7pt;">
							<img src="./upload/<%=orderinfo.get(6) %>" width=50 height=50></td>
				...
				else
				{
					for(int i = 0; i < basketlist.size(); i++)
					{
						...
						<tr align=center height=20>
							<td style="font-family: Tahoma; font-size: 7pt;">
								<img src="./upload/<%=goods.getGOODS_IMAGE().split(",")[0] %>" width=50 height=50>
							</td>
						...
						<tr>
							<td style="background-color: #F0F0F0; height: 1px;" coslpan=6>
						</tr>
						<%
					}
				}
		...
		<table width=80% border=0 cellpadding="0" cellspacing="1">
			...
			<tr height=20>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_NAME" size=12 value="<%=member.getMEMBER_NAME() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
			...
			<tr height=23>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_PHONE" size=15 value="<%=member.getMEMBER_PHONE() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px; colspan=6">
			...
			<tr height=20>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_MOBILE" size=15 value="<%=member.getMEMBER_MOBILE() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
			...
			<tr height=20>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_ZIPCODE" size=7 value="<%=member.getMEMBER_ZIPCODE() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
			...
			<tr height=20>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_ADDR1" size=50 value="<%=member.getMEMBER_ADDR1() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
			...
			<tr height=20>
				...
				<td style="font-family: Tahoma; font-size: 8pt;">
					<input type="text" name="ORDER_RECEIVE_ADDR2" size=50 value="<%=member.getMEMBER_ADDR2() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
		...
		<table width=80% border=0 cellpadding="0" cellspacing="1">
			...
			<tr>
				<td><b><font size=2>결재 정보</font></b></td>
			</tr>
			<tr>
				<td style="font-family: Tahoma; font-size: 8pt;" width=200 height=24 bgcolor="f7f7f7">입금자명(온라인입금일 경우) :</td>
				<td width=320 height=24>
					<input type="text" name="ORDER_TRADE_PAYER" size=20 value="<%=member.getMEMBER_NAME() %>">
				</td>
			</tr>
			<tr>
				<td style="background-color: #F0F0F0; height: 1px;" colspan=6>
