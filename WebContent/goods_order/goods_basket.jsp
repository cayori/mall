...
<%						}else{		%>						
						<a href="#" onclick="javascript:alert('주문할 상품이 없습니다.')">[구매하기]</a>
<%						}
						if(item == null) {		%>
						<a href="./GoodsList.go?item=new_item">[계속 쇼핑하기]</a>
<%						}else{		%>						
						<a href="./Goods_Detail.go?item=<%=item%>&gr_goods_num=<%=gr_goods_num%>&isitem=<%=isitem%>">[계속 쇼핑하기]</a>
<%						}			%>
						</td>
					</tr>
				</table>
