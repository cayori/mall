				...
				<form name="joinform" action="./MemberJoinAction.me" method="post"
					...
					<table border="1" width="80%" height="80%">
						...
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
								name="MEMBER_ID" size="10" maxlength=15 /> <input type="button"
						...
						<tr>
							...
							<td><font size="2">&nbsp;&nbsp;&nbsp;&nbsp;(아이디와
									비밀번호는 문자와 숫자를 조합하여 2~12자리로 만들어 주세요)</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
								...
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
								name="MEMBER_EMAIL_GET" value="NO" /> <font size="2">수신
									안함</font>
							</td>
						</tr>
						<tr>
